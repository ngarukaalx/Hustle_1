...
$(document).ready(function () {
    ...
    // And later gets its related business
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            //Get businesses related to the user
            //make an ajax get request to the related business
            if (userId && !bizId) {
                $.ajax({
                    url: "http://127.0.0.1:5001/api/v1/biz/" + userId,
                    method: "GET",
                    headers: {
                        'Content-Type': 'application/json'
                    },
			    ...
			    $('.bs-desc').append(h3, br);
                            //get the business id for this biz
                            businessId = biz.id;
                            return false;
                        });
